...
function Library:SetupSettings()
	...
	UIConf:CreateSlider("整体缩放(%)", 65, 150, math.floor(Library.Config.UIScale * 100), function(v) 
		Library.Config.UIScale = v / 100; Library:RefreshDimensions() 
	end)
    
	UIConf:CreateSlider("窗口宽度", 50, 300, Library.Config.WindowWidth, function(v)
		Library.Config.WindowWidth = v; Library:RefreshDimensions()
	end)
    
    UIConf:CreateSlider("窗口最大高度", 60, 600, Library.Config.WindowMaxHeight, function(v)
